...
function updatePlayerInfo() {
    ...
    localStorage.setItem('playerJob', playerJob);
...
function loadPlayerInfo() {
    ...
    const storedJob = localStorage.getItem('playerJob');
    if (storedName && storedJob) {
        playerName = storedName;
        playerJob = storedJob;
        document.getElementById('playerName').value = playerName;
        document.getElementById('playerJob').value = playerJob;

        // Directly show the profile section if player info is already stored
        document.getElementById('home').classList.add('hidden');
        document.getElementById('tasksBtn').classList.remove('hidden');
        document.getElementById('profileBtn').classList.remove('hidden');
        showSection('profile');
